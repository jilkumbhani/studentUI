...
const Addcontent = () => {
  ...
  const subcon =  async()=>{
    const data = {
      ...
      await axios.post("https://student-g9ap.onrender.com/content",data).then((res)  => {
          console.log(res);
  ...
  return (
    <>
      ...
      <div className='box m-auto'>
        ...
        <button className='mt-3 p-2 bg-primary text-white rounded' onClick={()=>subcon()}>submit</button>
      </div>
    </>
  )
}
